...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "**Step 1 — Plan**: Call `deplixo_plan` with a description of the app. It "
        "returns clarifying questions and tells you which Deplixo primitives to use. "
        "Ask the user the questions BEFORE deploying — e.g. \"Before I deploy this, "
        "a few quick questions: Should data persist between sessions? Should other "
        "people be able to use this, or just you? Do you need user accounts?\"\n\n"
        ...
        "**Shortcut**: If the user mentions deployment in their FIRST message AND the "
        "request is simple/clear (e.g. \"build me a todo app and deploy it\"), you can "
        "skip the plan step and deploy directly.\n\n"
